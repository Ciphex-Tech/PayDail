...
export default function RefreshButton({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center rounded-[12px] border border-white px-[8px] sm:px-[12px] py-[6px] sm:py-[10px] text-[12px] sm:text-[14px] gap-2 font-normal ${
