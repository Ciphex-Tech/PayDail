...
export default function TotalBalanceCard({
  ...
  return (
    <section className="rounded-[14px] bg-[#3570D4] p-[15px] py-[15px] sm:pl-[28px] sm:pr-[18px] sm:pt-[28px] sm:pb-[30px]">
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <p className="text-[12px] sm:text-[14px] text-white">Total Balance</p>
            <button
              type="button"
            ...
            >
              <Image
                ...
                width={16}
                height={16}
                className="w-[13px] h-[13px] sm:w-[16px] sm:h-[16px]"
              />
            </button>
          </div>

          <p className="mt-2 text-[24px] sm:text-[32px] font-bold">
      ...
      <div className="mt-4 sm:mt-6 flex gap-[15px]">
        <button
          type="button"
          onClick={() => router.push("/deposit")}
          className="rounded-[10px] w-[50%] sm:w-[150px] flex items-center justify-center gap-[10px] bg-[#201F2D] px-[20px] sm:px-[30px] py-[10px] sm:py-[13px] text-[13px] font-medium text-white cursor-pointer"
        >
