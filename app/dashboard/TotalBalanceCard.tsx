    ...
    <section className="rounded-[14px] bg-[#3570D4] pl-[28px] pr-[18px] pt-[28px] pb-[30px]">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[30px] sm:text-[32px] font-bold">
      ...
      <div className="mt-6 flex gap-[30px]">
        <button
          ...
          className="rounded-[10px] w-[50%] sm:w-[150px] flex items-center justify-center gap-[10px] bg-[#201F2D] px-[30px] py-[14px] sm:py-[13px] text-[13px] font-medium text-white cursor-pointer"
        >
